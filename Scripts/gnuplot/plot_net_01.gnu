...
set output 'throughput_net_01.png'
...
# Graphic title
# set title "Trafego de pacotes capturados no Servidor da Rede 1" font "Bold,14" offset 0,-1.2
set title "Traffic captured on Network 1 server" font "Bold,14" offset 0,-1.2
