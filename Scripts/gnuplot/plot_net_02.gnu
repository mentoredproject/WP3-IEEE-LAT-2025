...
set output 'throughput_net_02.png'
...
set style line 1 lc rgb 'turquoise' dt "-" pt 2 lt 1 lw 1
set style line 2 lc rgb 'violet' dt 7 pt 163 lt 1 lw 3
set style line 3 lc rgb 'sea-green' dt 2 pt 3 lt 1 lw 1
set style line 4 lc rgb 'red' pt 161

set datafile missing '-'

# Graphic title
# set title "Trafego de pacotes capturados no Servidor da Rede 2" font "Bold,14" offset 0,-1.2
set title "Traffic captured on Network 2 server" font "Bold,14" offset 0,-1.2

# x axis configuration
set xtics border in scale 1,0.5 nomirror autojustify
set xtics 50
set xlabel "Time (s)" font "Bold,13" # offset 0,0.5
set xrange [ 0 : 1200 ] noreverse writeback
